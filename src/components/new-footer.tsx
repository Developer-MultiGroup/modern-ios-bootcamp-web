...
export function SimpleFooterWithFourGrids() {
  ...
  return (
    <div className="border-t border-neutral-100 dark:border-white/[0.1] px-8 py-20 bg-[#1C1C1C] w-full relative overflow-hidden">
  ...
  return (
    ...
    >
      <Image
        ...
        height={30}
      />
      <span className="font-medium text-black dark:text-white">MultiGroup</span>
    </Link>
  );
};
